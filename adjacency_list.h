...
public:
  ...
  void set_edge(int v1, double edge_label, int v2);
  ...
  bool get_edge(int v1, int v2, double& edge) const; 
  ...
  //removing all eddes between the src and the end
  bool remove_edge(int src,int end);
...
private:
  ...
  // linked-list array of out edges (for connected_from)
  Node** adj_list_out;
  // linked-list array of in edges (for connected_to)
  Node** adj_list_in;
